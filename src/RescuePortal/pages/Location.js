  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-bl from-[#BAAC9A] to-white flex flex-col  items-center justify-center text-white">
        ...
        <div className="flex flex-col flex-wrap md:flex-row justify-center gap-10  mt-12 ">
          <Link
            to="/requirements"
            className="relative border-2 border-[#c7aa8b] bg-[#323232] shadow-md shadow-[#62553B] px-4 py-4 transition ease-in-out delay-50 hover:-translate-y-2 duration-500"
          >
